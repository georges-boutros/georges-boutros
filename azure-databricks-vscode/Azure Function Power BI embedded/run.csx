...
static string clientSecret = Environment.GetEnvironmentVariable("PBIE_CLIENT_SECRET");
...
static string groupId = Environment.GetEnvironmentVariable("PBIE_GROUP_NUM_ID");
static string reportId = Environment.GetEnvironmentVariable("PBIE_REPORT_CLICKTRACKING_ID");
